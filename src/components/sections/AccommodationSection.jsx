      ...
      <div className="max-w-4xl mx-auto">
          ...
          <Card className="overflow-hidden border-2 border-wedding-primary/20 shadow-2xl bg-white dark:bg-gray-900 p-0">
            <div className="bg-gradient-to-r from-wedding-primary to-wedding-primary-dark p-4 sm:p-5 md:p-6">
              <div className="flex flex-col sm:flex-row items-center sm:items-start gap-3 sm:gap-4 text-white text-center sm:text-left">
                ...
                <div>
                  <h3 className="text-lg sm:text-xl md:text-2xl font-serif">{t('home.accommodation.venue')}</h3>
                  <p className="text-white/90 text-xs sm:text-sm">{t('home.accommodation.available')}</p>
                </div>
              </div>
            </div>
            ...
            <CardContent className="p-4 sm:p-5 md:p-6">
              ...
              <div className="mb-4 sm:mb-6 space-y-3 sm:space-y-4">
                <h4 className="text-base sm:text-lg font-serif text-wedding-primary-dark dark:text-wedding-primary flex items-center gap-2">
                  ...
                  {t('home.accommodation.apartmentsTitle')}
                </h4>
                ...
                <div className="bg-gradient-to-br from-wedding-primary/5 to-wedding-secondary/5 rounded-xl p-3 sm:p-4 border border-wedding-primary/20">
                  <h5 className="font-semibold text-sm sm:text-base mb-2 text-gray-900 dark:text-white">
                    {t('home.accommodation.apartment1.title')}
                  </h5>
                  <ul className="space-y-1.5 text-xs sm:text-sm text-gray-600 dark:text-gray-300">
                    <li className="flex items-start gap-2">
                      ...
                      <span>{t('home.accommodation.apartment1.bed')}</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <DollarSign className="w-3 h-3 sm:w-4 sm:h-4 text-wedding-primary mt-0.5 flex-shrink-0" />
                      <span><strong>{t('home.accommodation.apartment1.firstNight')}</strong> {t('home.accommodation.apartment1.firstNightPrice')}</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <DollarSign className="w-3 h-3 sm:w-4 sm:h-4 text-wedding-primary mt-0.5 flex-shrink-0" />
                      <span><strong>{t('home.accommodation.apartment1.additionalNights')}</strong> {t('home.accommodation.apartment1.additionalNightsPrice')}</span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="bg-gradient-to-br from-wedding-primary/5 to-wedding-secondary/5 rounded-xl p-3 sm:p-4 border border-wedding-primary/20">
                  <h5 className="font-semibold text-sm sm:text-base mb-2 text-gray-900 dark:text-white">
                    {t('home.accommodation.apartment2.title')}
                  </h5>
                  <div className="space-y-2 sm:space-y-3">
                    <div>
                      <p className="text-xs sm:text-sm font-medium text-wedding-primary-dark dark:text-wedding-primary mb-1">{t('home.accommodation.apartment2.option1')}</p>
                      <ul className="space-y-1 text-xs sm:text-sm text-gray-600 dark:text-gray-300 ml-3 sm:ml-4">
                        <li className="flex items-start gap-2">
                          ...
                          <span>{t('home.accommodation.apartment2.option1Bed')}</span>
                        </li>
                      </ul>
                    </div>
                    <div>
                      <p className="text-xs sm:text-sm font-medium text-wedding-primary-dark dark:text-wedding-primary mb-1">{t('home.accommodation.apartment2.option2')}</p>
                      <ul className="space-y-1 text-xs sm:text-sm text-gray-600 dark:text-gray-300 ml-3 sm:ml-4">
                        <li className="flex items-start gap-2">
                          <span className="text-wedding-primary flex-shrink-0">•</span>
                          <span>{t('home.accommodation.apartment2.option2Bed1')}</span>
                        </li>
                        <li className="flex items-start gap-2">
                          <span className="text-wedding-primary flex-shrink-0">•</span>
                          <span>{t('home.accommodation.apartment2.option2Bed2')}</span>
                        </li>
                      </ul>
                    </div>
                    <ul className="space-y-1.5 text-xs sm:text-sm text-gray-600 dark:text-gray-300 pt-2 border-t border-wedding-primary/10">
                      <li className="flex items-start gap-2">
                        <DollarSign className="w-3 h-3 sm:w-4 sm:h-4 text-wedding-primary mt-0.5 flex-shrink-0" />
                        <span><strong>{t('home.accommodation.apartment2.firstNight')}</strong> {t('home.accommodation.apartment2.firstNightPrice')}</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <DollarSign className="w-3 h-3 sm:w-4 sm:h-4 text-wedding-primary mt-0.5 flex-shrink-0" />
                        <span><strong>{t('home.accommodation.apartment2.additionalNights')}</strong> {t('home.accommodation.apartment2.additionalNightsPrice')}</span>
                      </li>
                    </ul>
                  </div>
                </div>
                ...
                <div className="bg-wedding-secondary/10 rounded-xl p-3 sm:p-4 border border-wedding-secondary/20">
                  <div className="flex items-center gap-2 mb-2 sm:mb-3">
                    ...
                    <h5 className="font-semibold text-sm sm:text-base text-gray-900 dark:text-white">{t('home.accommodation.schedules.title')}</h5>
                  </div>
                  <div className="grid grid-cols-2 gap-2 sm:gap-3 text-xs sm:text-sm">
                    <div>
                      <p className="font-medium text-wedding-secondary-dark dark:text-wedding-secondary">{t('home.accommodation.schedules.checkIn')}</p>
                      <p className="text-gray-600 dark:text-gray-300">{t('home.accommodation.schedules.checkInTime')}</p>
                    </div>
                    <div>
                      <p className="font-medium text-wedding-secondary-dark dark:text-wedding-secondary">{t('home.accommodation.schedules.checkOut')}</p>
                      <p className="text-gray-600 dark:text-gray-300">{t('home.accommodation.schedules.checkOutTime')}</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-wedding-primary/5 dark:bg-wedding-primary-dark/5 rounded-xl p-3 sm:p-4 md:p-5 border border-wedding-primary/20">
                <h4 className="font-semibold text-sm sm:text-base mb-3 sm:mb-4 text-wedding-primary-dark dark:text-wedding-primary">
                  {t('home.accommodation.reservations.title')}
                </h4>
                ...
                <div className="mt-3 sm:mt-4 p-2.5 sm:p-3 bg-wedding-secondary/10 rounded-lg border border-wedding-secondary/20">
                  <p className="text-xs sm:text-sm text-gray-700 dark:text-gray-200 leading-relaxed">
                    <strong className="text-wedding-secondary-dark dark:text-wedding-secondary">{t('home.accommodation.reservations.important')}</strong>
                    {" "}{t('home.accommodation.reservations.importantMessage')}
                  </p>
                </div>
              </div>
            </CardContent>
        ...
        >
          <p className="text-xs sm:text-sm text-muted-foreground italic">
            {t('home.accommodation.availabilityNote')}
          </p>
        </motion.div>
      </div>
    </motion.section>
